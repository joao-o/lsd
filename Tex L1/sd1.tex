...
Sendo o último algarismo de um número inteiro em base três dado pelo resto da primeira divisão desse número por três, podemos ver na operação aritmética apresentada em (8) que o algarismo menos significativo da soma dos nossos números é 2. Logo, apenas realizaremos a função S\textsubscript{1} e C\textsubscript{0}. 
...
\begin{split}
S_1(A_1,A_0,B_1,B_0) & = A_0\overline{B_1}B_0 + A_1B_1 \\
       & = \overline{(\overline{(A_0 \cdot \overline{B_1} \cdot B_0)}\cdot\overline{(A_1 \cdot B_1)})}  \\   
\end{split}
\end{equation}
\begin{equation}
\begin{split}
C_0(A_1,A_0,B_1,B_0) & = A_0\overline{B_0} + A_1B_0 \\
       & = \overline{(\overline{(A_0 \cdot \overline{B_0})}\cdot\overline{(A_1 \cdot B_0)})}  \\   
\end{split}
\end{equation}
...
\begin{split}
S_1(A_1,A_0,B_1,B_0) & = A_0\overline{B_1}B_0 + A_1B_1 \\
       & = \overline{\overline{((A_0 \cdot \overline{B_1} \cdot B_0)+(A_1 \cdot B_1))}}  \\   
       & = \overline{\overline{(\overline{(\overline{A_0} + B_1 + \overline{B_0})}+\overline{(\overline{A_1} + \overline{B_1})})}}  \\   
\end{split}
\end{equation}
\begin{equation}
\begin{split}
C_0(A_1,A_0,B_1,B_0) & = A_0\overline{B_0} + A_1B_0 \\
       & = \overline{\overline{(A_0 \cdot \overline{B_0}) + (A_1 \cdot B_0)}}  \\   
       & = \overline{\overline{(\overline{\overline{A_0} + B_0}) + (\overline{\overline{A_1} + \overline{B_0})}}}  \\   
\end{split}
\end{equation}
Requisitos de implementação:
\begin{enumerate}
...
\begin{split}
S_1(A_1,A_0,B_1,B_0) & = (B_0)(A_1+\overline{B_1})(A_0+B_1) \\
	& = \overline{(\overline{B_0}+\overline{(A_1+\overline{B_1})}+\overline{(A_0+B_1)})}\\
\end{split}
\end{equation}
\begin{equation}
\begin{split}
